...
passedData = cgi.FieldStorage()

givenUser = "jSmith" #passedData.getvalue('givenUsername')
givenPass = "hunter2" #passedData.getvalue('givenPassword')
...
#Use SQLite Viewer extention of view mydb.db contents.
